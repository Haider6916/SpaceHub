...
const AddEvent = ({navigation}) => {
  ...
  const postData = () => {
    ...
    axios
      .post(
        `https://dolphin-app-oz4sf.ondigitalocean.app/api/v1/event/`,
        formdata,
        {
          headers: {
  ...
  const handleSaveTime = date => {
    const formatt = moment(date).format('HH:mm:ss.SSSZ');
    console.log('====================================Ammarrr');
    setbackEndStart(formatt);
    console.log('====================================start');
    console.log(backEndStart);
    console.log('====================================');
    console.log('====================================');
  ...
  const handleTotalSeatChange = (text) => {
    // Remove non-numeric characters
    const numericValue = text.replace(/[^0-9]/g, '');
  
    // Update the state and display a toast message if the value is invalid
    setTotalseat(numericValue);
  
    if (text !== numericValue) {
      SimpleToast.show('Please enter only numbers',SimpleToast.TOP);
    }
  };
  ...
  return (
    <>
      ...
      onSwipeComplete={() => setMap(false)}
      backPressed={() => setMapsetMap(false)}
        ...
        <ScrollView>
          ...
          <View>
            <CustomTextInput
              ...
              icon={<Sofa />}
              value={totalseat}
              onChangeText={handleTotalSeatChange}
